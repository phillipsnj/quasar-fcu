...
import DefaultEventVariables from "components/modules/canacc8/canacc8EventVariables";
...
const update_rows = () => {
  console.log(`canacc8EventList Mounted ${store.state.selected_node}`)
  rows.value = []
...
const editEvent = (eventIndex) => {
  ...
  store.methods.update_event_component("canacc8EventVariables")
}
