...
import Canled64EventVariables from "components/modules/canled64/canled64EventVariables";
...
onBeforeMount(() => {
  console.log(`Canled64EventList Mounted ${store.state.selected_node}`)
...
const editEvent = (eventIndex) => {
  ...
  store.methods.update_event_component("Canled64EventVariables")
}
