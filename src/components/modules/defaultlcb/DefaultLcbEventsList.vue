...
import DefaultLcbEventVariables from "components/modules/defaultlcb/DefaultLcbEventVariables";
...
const editEvent = (eventIndex) => {
  ...
  store.methods.update_event_component("DefaultLcbEventVariables")
}
